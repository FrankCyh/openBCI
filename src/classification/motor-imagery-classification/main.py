...
X_imagery_LH, y_imagery_LH = data_generator.read_and_select_columns(os.path.join(DIR_NAME, "imagery_LH"), selected_columns)
X_imagery_RH, y_imagery_RH = data_generator.read_and_select_columns(os.path.join(DIR_NAME, "imagery_RH"), selected_columns)
