...
load_filename_pair = [
    ('OpenBCI-RAW-2023-11-25_19-24-37_yuhe.txt',   'white_time_yuhe.txt'),
    ('OpenBCI-RAW-2023-11-25_19-34-34_xiao.txt',   'white_time_xiao.txt'),
    ('OpenBCI-RAW-2023-11-25_19-45-02_jiayi.txt',  'white_time_jiayi.txt'),
    ('OpenBCI-RAW-2023-11-25_19-54-15_leting.txt', 'white_time_leting.txt')
]
...
for curr_epoch in range(epoch):
    ...
    # print stats
    print(f"epoch: {curr_epoch}, train acc: {train_acc}, val acc: {val_acc}")
...
if True:
    ...
    onnx_path = os.path.join('saved_models', 'trial.onnx')
